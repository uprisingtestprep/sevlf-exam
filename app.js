/* SEVLF Exam Simulator, Application Logic */

const ACCESS_CODE  = "SEVLF9000";
const EXAM_SECONDS = 23400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "sevlf_exam_state_v1";
const SIM_Q_COUNT  = 60;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Scenario";
const DOMAIN_LABELS = {"wind_load_determination": "Wind Load Determination", "seismic_load_determination": "Seismic Load Determination", "lateral_force_distribution_and_analysis_methods": "Lateral Force Distribution and Analysis Methods", "steel_lateral_force_resisting_systems": "Steel Lateral Force-Resisting Systems", "concrete_lateral_force_resisting_systems": "Concrete Lateral Force-Resisting Systems", "wood_and_masonry_lateral_force_resisting_systems": "Wood and Masonry Lateral Force-Resisting Systems", "connections_and_structural_system_integration": "Connections and Structural System Integration", "foundations_and_retaining_structures_for_lateral_loads": "Foundations and Retaining Structures for Lateral Loads", "general_analysis_of_existing_secondary_and_nonbuilding_structures": "General Analysis of Existing Secondary and Nonbuilding Structures"};  // maps domain key -> human-readable label for display
